...
=======
  ...
  const resetCustomerForm = () => {
    ...
    setPhoneFixed("");
    setPhoneMobile("");
>>>>>>> 73bf4ca6586ff849abc87d601ab9265eded94de6
  };
    ...
    <Layout>
      ...
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
          Προβολή και διαχείριση πελατών, ιστορικού οχημάτων και προγράμματος
          επιβράβευσης
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">
        ...
        <div className="w-full md:w-1/4">
          <select
            ...
            onChange={(e) =>
              setSelectedType(
                e.target.value as "ALL" | "AUTO" | "MOTO" | "YACHT" | "AVIATION"
              )
            }
            value={selectedType}
          >
                    ...
                    >
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <div className="text-sm text-gray-500 dark:text-gray-400">
                          Πελάτης από {customer.dateAdded}
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
          ...
          <div className="lg:w-1/3 bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
            <div className="p-6">
              ...
              <div className="mt-4 space-y-6">
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-gray-900 dark:text-white">
                        {selectedCustomer.type === "AUTO"
                          ? "Αυτοκίνητο"
                          : selectedCustomer.type === "MOTO"
                          ? "Μοτοσυκλέτα"
                          : selectedCustomer.type === "YACHT"
                          ? "Σκάφος"
                          : "Αεροσκάφος"}
                      </span>
                    </div>
                  ...
                  <div className="mt-2 space-y-2">
                    <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-md">
                      ...
                      <div className="text-xs text-gray-500 dark:text-gray-400">
                        Ολοκληρώθηκε: 15/02/2025
                      </div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">
                        Εγγύηση έως: 15/02/2030
                      </div>
                    </div>
                    <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-md">
                      <div className="text-sm font-medium text-gray-900 dark:text-white">
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">
                    Επόμενη Προβλεπόμενη Συντήρηση
                  </h3>
                  <div className="mt-2 bg-gray-50 dark:bg-gray-700 p-3 rounded-md">
                    <div className="text-sm font-medium text-gray-900 dark:text-white">
                      Ανανέωση Ceramic Pro
                    </div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">
                      Προτεινόμενη ημερομηνία: 15/08/2025
                    </div>
...
=======
                  <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Συμπληρώνεται εφόσον έχετε επιλέξει Αυτοκίνητο ή Μοτοσυκλέτα
                  </p>
                </div>
                <div>
                  <label
